...
var officeDesktopAppClientId1 = '0ec893e0-5785-4de6-99da-4ed124e5296c'
...
var authorizedClientApplicationIds = '${teamsMobileOrDesktopAppClientId};${teamsWebAppClientId};${officeDesktopAppClientId1};${officeWebAppClientId1};${officeWebAppClientId2};${outlookDesktopAppClientId};${outlookWebAppClientId}'
